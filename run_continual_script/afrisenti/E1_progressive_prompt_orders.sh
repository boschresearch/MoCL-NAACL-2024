...
for seed in 0 1 2
    do
        ...
        python3 src/run_continual_mtl_afrisenti.py \
            ...
            --pre_seq_len $psl \
            --output_dir checkpoints_continual_afrisenti/order1_E1_progressive_prompt \
        ...
        python3 src/run_continual_mtl_afrisenti.py \
            ...
            --num_train_epochs $epoch \
            --pre_seq_len $psl \
            --output_dir checkpoints_continual_afrisenti/order2_E1_progressive_prompt \
            --overwrite_output_dir \
            --hidden_dropout_prob $dropout \
            --seed $seed \
            --save_strategy epoch \
        ...
        python3 src/run_continual_mtl_afrisenti.py \
            ...
            --num_train_epochs $epoch \
            --pre_seq_len $psl \
            --output_dir checkpoints_continual_afrisenti/order3_E1_progressive_prompt \
            --overwrite_output_dir \
            --hidden_dropout_prob $dropout \
            --seed $seed \
            --save_strategy epoch \
