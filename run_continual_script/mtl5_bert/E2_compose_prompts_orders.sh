...
for seed in 0 1 2
    do
        ...
        python3 src/run_continual_mtl5_bert.py \
            ...
            --continual_learning \
            --compose_prompts \
            --query_encoder_type avg_all_embed \
            --task_specific_classifier \
            --direct_compose False \
            --softmax_match_scale 8 \
            --matching_loss_v2 \
            ...
            --output_dir checkpoints_continual_mtl5_bert/order1_E2_compose_prompts \
        ...
        python3 src/run_continual_mtl5_bert.py \
            ...
            --n_train_total ${n_train_total} \
            --n_val_per_class ${n_val_per_class} \
            --output_dir checkpoints_continual_mtl5_bert/order2_E2_compose_prompts \
            --overwrite_output_dir \
            --hidden_dropout_prob $dropout \
            --seed $seed \
            --save_strategy epoch \
        ...
        python3 src/run_continual_mtl5_bert.py \
            ...
            --n_train_total ${n_train_total} \
            --n_val_per_class ${n_val_per_class} \
            --output_dir checkpoints_continual_mtl5_bert/order3_E2_compose_prompts \
            --overwrite_output_dir \
            --hidden_dropout_prob $dropout \
            --seed $seed \
            --save_strategy epoch \
