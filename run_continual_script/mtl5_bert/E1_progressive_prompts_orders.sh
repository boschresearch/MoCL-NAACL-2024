...
for seed in 0 1 2
    do
        ...
        python3 src/run_continual_mtl5_bert.py \
            ...
            --output_dir checkpoints_continual_mtl5_bert/order1_E1_progressive_prompts \
        ...
        python3 src/run_continual_mtl5_bert.py \
            ...
            --n_train_total ${n_train_total} \
            --n_val_per_class ${n_val_per_class} \
            --output_dir checkpoints_continual_mtl5_bert/order2_E1_progressive_prompts \
            --overwrite_output_dir \
            --hidden_dropout_prob $dropout \
            --seed $seed \
            --save_strategy epoch \
        ...
        python3 src/run_continual_mtl5_bert.py \
            ...
            --n_train_total ${n_train_total} \
            --n_val_per_class ${n_val_per_class} \
            --output_dir checkpoints_continual_mtl5_bert/order3_E1_progressive_prompts \
            --overwrite_output_dir \
            --hidden_dropout_prob $dropout \
            --seed $seed \
            --save_strategy epoch \
        ...
        python3 src/run_continual_mtl5_bert.py \
            ...
            --n_train_total ${n_train_total} \
            --n_val_per_class ${n_val_per_class} \
            --output_dir checkpoints_continual_mtl5_bert/order4_E1_progressive_prompts \
            --overwrite_output_dir \
            --hidden_dropout_prob $dropout \
            --seed $seed \
            --save_strategy epoch \
