...
from training.trainer_continual_mtl_afrisenti import ContinualTrainerMTL
from tasks.afrisenti.dataloader_mtl import DataLoaderMTL
...
if __name__ == "__main__":
    ...
    model = get_model(
        ...
        config=config, 
        seed=seed,
        mtl=model_args.multi_peft_modules,
