...
for seed in 0 1 2
    do   
        ...
        python3 src/run_continual_mtl5_t5.py \
            ...
            --pre_seq_len $psl \
            --output_dir checkpoints_continual_mtl5_t5/order1_E2_compose_prompts \
        ...
        python3 src/run_continual_mtl5_t5.py \
            ...
            --num_train_epochs $epoch \
            --pre_seq_len $psl \
            --output_dir checkpoints_continual_mtl5_t5/order2_E2_compose_prompts \
            --overwrite_output_dir \
            --hidden_dropout_prob $dropout \
            --seed $seed \
            --save_strategy epoch \
        ...
        python3 src/run_continual_mtl5_t5.py \
            ...
            --num_train_epochs $epoch \
            --pre_seq_len $psl \
            --output_dir checkpoints_continual_mtl5_t5/order3_E2_compose_prompts \
            --overwrite_output_dir \
            --hidden_dropout_prob $dropout \
            --seed $seed \
            --save_strategy epoch \
