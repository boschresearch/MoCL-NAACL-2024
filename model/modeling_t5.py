...
T5_PRETRAINED_MODEL_ARCHIVE_LIST = [
    "t5-small",
    "/fs/scratch/rb_bd_dlp_rng-dl01_cr_AIM_employees/model_cache/t5-base",
    "/fs/scratch/rb_bd_dlp_rng-dl01_cr_AIM_employees/model_cache/t5-large",
    "/fs/scratch/rb_bd_dlp_rng-dl01_cr_AIM_employees/model_cache/t5-3b",
    "t5-11b",
    ...
    Args:
        device_map (:obj:`Dict[int, list]`, optional, defaults to None):
            ...
            following number of attention modules:
                ...
                - t5-small: 6
                - t5-base: 12
                - /fs/scratch/rb_bd_dlp_rng-dl01_cr_AIM_employees/model_cache/t5-large: 24
                - t5-3b: 24
                - t5-11b: 24
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def forward(
        ...
        # Remove the implementation according to: https://github.com/huggingface/transformers/issues/13711
